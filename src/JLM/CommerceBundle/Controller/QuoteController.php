...
class QuoteController extends ContainerAware
{
    ...
    public function newAction()
    {
        ...
        return $manager->renderResponse('JLMCommerceBundle:Quote:new.html.twig', [
...
//          var_dump($form->getData()->getEvents()[2]); exit;
        ...
        return $manager->renderResponse('JLMCommerceBundle:Quote:edit.html.twig', [
            'entity'      => $entity,
    ...
    public function printAction($id)
    {
        ...
        return $manager->renderPdf($filename, 'JLMCommerceBundle:Quote:quote.pdf.php', ['entities'=>[$entity->getVariants()]]);
    }
    ...
    public function mailAction($id)
    {
        ...
        $mail->setSignature($manager->renderView('JLMCommerceBundle:QuoteVariant:emailsignature.txt.twig', ['name' => $entity->getFollowerCp()]));
        ...
        return $manager->renderResponse('JLMCommerceBundle:Quote:mail.html.twig', [
                'entity' => $entity,
                'form'   => $form->createView()
        ]);
    }
            ...
            foreach ($entity->getVariants() as $variant) {
                if ($variant->getState() > 0) {
                    $message->attach(\Swift_Attachment::newInstance(
                        $manager->renderResponse('JLMCommerceBundle:Quote:quote.pdf.php', ['entities'=>[$variant]]),

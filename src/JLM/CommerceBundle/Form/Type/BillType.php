...
class BillType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('property', null, ['label'=>'Clause de propriété','required'=>false,'attr'=>['class'=>'input-xxlarge']])
            
            ->add('earlyPayment', null, ['label'=>'Escompte','attr'=>['class'=>'input-xxlarge']])
            ->add('penalty', null, ['label'=>'Penalités','attr'=>['class'=>'input-xxlarge']])
            
            ->add('intro', null, ['label'=>'Introduction','required'=>false,'attr'=>['class'=>'span12','placeholder'=>'Suite à ...']])
            ->add('lines', 'collection', ['prototype'=>true,'allow_add'=>true,'allow_delete'=>true,'type'=>'jlm_commerce_bill_line'])

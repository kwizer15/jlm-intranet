...
class BillBoost extends FPDFext
{
    ...
    private function init(BillInterface $entity)
    {
        $this->police = 'Times';
        $this->addPage('P');
    ...
    private function show(BillInterface $entity)
    {
        $this->setFont($this->police, '', 13);
        ...
        if ($entity->getFirstBoost() === null) {
            ...
            $this->cell(
                0,
                5,
                'Nous nous permettons de vous signaler qu\'à ce jour nous n\'avons toujours pas enregistré le',
                0,
                1,
                'FJ'
            );
            ...
            $this->cell(
                ...
                . $entity->getNumber()
                . ' du '
                . $entity->getCreation()->format('d/m/Y')
                . ' de '
                . number_format($entity->getTotalPriceAti(), 2, ',', ' ')
                . ' €',
                0,
                1,
                'C'
            ...
            $this->cell(
                0,
                5,
                'Afin de régulariser cette situation, nous vous prions de bien vouloir nous faire parvenir votre',
                0,
                1,
                'FJ'
            );
            ...
            $this->cell(
                0,
                5,
                'Dans le cas ou le réglement serait en cours, veuillez ne pas tenir compte de ce rappel.',
                0,
                1
            );
            $this->ln(5);
            ...
            $this->cell(
                0,
                5,
                'Notre dernier courrier étant resté sans effet, nous vous signalons qu\'à ce jour,'
            ...
            $this->cell(
                0,
                5,
                'de notre part, la facture n°'
                . $entity->getNumber()
                . ' ci-jointe pour un montant de '
                . number_format($entity->getTotalPriceAti(), 2, ',', ' ')
            ...
            $this->cell(
                0,
                5,
                'Comptant sur votre diligence, nous vous prions d\'agréer, Madame, Monsieur l\'expression de nos',
                0,
                1,
                'FJ'
            );

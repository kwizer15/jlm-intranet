...
!function ($) {
    ...
    $.fn.quote = function (option) {
        return this.each(function () {
            ...
            if (!data) {
                $this.data('quote', (data = new Quote(this, options)))
...
!function ($) {
            ...
            , listen : function () {
                ...
                $("#quote_variant_paymentRules").attr('data-source',this.options.autoSource).autocomplete({
                    source: function (request,response) {
                        ...
                        return $.post(this.element.attr('data-source'),request,function ( data ) {
                            response(data); },'json');
                    }});
    ...
    $.fn.quotevariant = function (option) {
        return this.each(function () {
            ...
            , options = typeof option == 'object' && option
            if (!data) {
                $this.data('quotevariant', (data = new QuoteVariant(this, options)))
                if (typeof option == 'string') {
                    data[option]()
                }
            }
...
!function ($) {
    ...
    $.fn.quoteline = function (option) {
        return this.each(function () {
            ...
            , options = typeof option == 'object' && option
            if (!data) {
                $this.data('quoteline', (data = new QuoteLine(this, options)))
                if (typeof option == 'string') {
                    data[option]()
                }
            }

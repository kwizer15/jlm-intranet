...
class FixingCloseType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('partFamily', 'jlm_daily_partfamilytype', ['label'=>'Famille de pièce','attr'=>['class'=>'input-large']])
            ...
            ->add('report', 'textarea', ['label'=>'Action menée','required'=>false,'attr'=>['class'=>'input-xlarge']])
            ->add('rest', 'textarea', ['label'=>'Reste à faire','required'=>false,'attr'=>['class'=>'input-xlarge']])
            ->add('voucher', null, ['label'=>'Bon d\'intervention','required'=>false,'attr'=>['class'=>'input-small']])
        ;
    }

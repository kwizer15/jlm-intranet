...
class Door extends FPDFext
{
    ...
    private function customHeader(ModelDoor $door)
    {
    ...
    private function show(ShiftTechnician $entity)
    {
        ...
        if ($entity->getEnd()) {
            $datas[6] .= chr(10) . $entity->getBegin()->format('H\hi') . ' - '
                . $entity->getEnd()->format('H\hi') . chr(10) . $entity->getTime()->format('%h:%I');
        }

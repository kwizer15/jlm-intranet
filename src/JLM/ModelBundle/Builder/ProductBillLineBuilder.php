...
class ProductBillLineBuilder extends BillLineBuilderAbstract
{
    ...
    {
        $price = isset($this->options['price'])
            ? $this->options['price']
    ...
    public function buildProduct()
    {
        ...
        $desig = isset($this->options['designation']) ? $this->options['designation']
            : $this->product->getDesignation();
        $this->getLine()->setDesignation($desig);
        $descr = isset($this->options['description']) ? $this->options['description']

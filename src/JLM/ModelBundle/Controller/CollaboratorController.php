...
use JLM\ModelBundle\Entity\Collaborator;
use JLM\ModelBundle\Form\CollaboratorType;
...
class CollaboratorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JLMModelBundle:Collaborator')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JLMModelBundle:Collaborator')->find($id);
     ...
     * @Method("post")
     * @Template("JLMModelBundle:Collaborator:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("JLMModelBundle:Collaborator:edit.html.twig")
     */

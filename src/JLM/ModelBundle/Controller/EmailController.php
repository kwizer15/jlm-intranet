...
use JLM\ModelBundle\Entity\Email;
use JLM\ModelBundle\Form\EmailType;
...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JLMModelBundle:Email')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JLMModelBundle:Email')->find($id);
     ...
     * @Method("post")
     * @Template("JLMModelBundle:Email:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("JLMModelBundle:Email:edit.html.twig")
     */

...
namespace JLM\TestBundle\Controller;
...
use JLM\TestBundle\Entity\Test;
use JLM\TestBundle\Form\TestType;
...
class TestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JLMTestBundle:Test')->findAll();
     ...
     * @Method("POST")
     * @Template("JLMTestBundle:Test:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JLMTestBundle:Test')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JLMTestBundle:Test:edit.html.twig")
     */

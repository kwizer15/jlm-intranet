...
class SeriesType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('model', 'entity', ['class'=>'JLM\TransmitterBundle\Entity\Model','label'=>'Type d\'émetteurs','empty_value' => 'Choisissez...',])
            ->add('quantity', null, ['label'=>'Nombre d\'émetteurs', 'attr'=>['class'=>'input-mini','maxlength'=>3]])
            ...
            ->add('guarantee', null, ['label'=>'Garantie','attr'=>['placeholder'=>'MMAA','class'=>'input-mini','maxlength'=>4]])
        ;
    }

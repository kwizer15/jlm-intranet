...
class AttributionList extends FPDFext
{
    ...
    public static function get($entity, $transmitters, $withHeader = true)
    {
        $pdf = new self();
    ...
    private function init($entity)
    {
        ...
        $this->cell(0, 9, 'Liste du '.$entity->getCreation()->format('d/m/Y'), 0, 0);
        $this->setXY(100, 55);

...
class QuoteVariantConfirmGivenMailBuilder extends QuoteVariantMailBuilder
{
    ...
    {
        $this->setSubject(
            'Confirmation de réception de votre accord sur devis n°' . $this->getQuoteVariant()->getNumber()
        );
    }
    ...
    public function buildBody()
    {
        $this->setBody(
            ...
            . 'Nous accusons bonne réception de votre accord sur le devis n°' . $this->getQuoteVariant()->getNumber(
            ) . '.' . chr(10)

...
class Quote extends CommercialPart
{
     ...
     * {@inheritdoc}
     */
    public function customHeader($options)
    {
        // Follower
    ...
    public function customFooter()
    {
        ...
        $this->setFont('Arial', 'B', 10);
        $this->cell(
            $this->colsize[0] + $this->colsize[1] + $this->colsize[2] + $this->colsize[3] + $this->colsize[4],
            6,
            'MONTANT TOTAL H.T',
            1,
            0,
        ...
        $this->cell(
            $this->colsize[5],
            6,
            number_format($this->entity->getTotalPrice(), 2, ',', ' ') . ' €',
            1,
            1,
            'R',
            true
        ...
        $this->cell(
            $this->colsize[5],
            6,
            number_format($this->entity->getTotalPriceAti(), 2, ',', ' ') . ' €',
            1,
            1,
            'R'
        );
        ...
        $this->multiCell(
            $cs,
            5,
            'Nous vous en souhaitons bonne réception et vous prions d\'agréer, '
            . $who
        ...
        $this->cell(
            0,
            4,
            'JLM conserve l\'entière propriété des marchandises jusqu\'au complet paiement du prix facturé.',
            '',
            1
        );
        $this->setFont('Arial', 'B', 7);
